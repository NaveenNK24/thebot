  ...
  const renderOptionRow = (option) => {
    ...
    return (
      <tr key={strike_price}>
        ...
        <td 
          className="clickable" 
          onClick={() => handleNavigate('/chart/upstox', call_options.instrument_key)}
          style={{ cursor: 'pointer', color: 'blue', textDecoration: 'underline' }}
        >
          {renderOptionData(call_options.market_data.ltp)}
        </td>
        <td 
          className="strike-price" 
          // onClick={() => handleNavigate('/historical-data', strike_price)}
          style={{ cursor: 'pointer' }}
        >
          {strike_price}
        </td>
        <td 
          className="clickable" 
          onClick={() => handleNavigate('/chart/upstox', put_options.instrument_key)}
          style={{ cursor: 'pointer', color: 'blue', textDecoration: 'underline' }}
        >
          {renderOptionData(put_options.market_data.ltp)}
        </td>
        <td>{renderOptionData(put_options.market_data.volume)}</td>
        <td>{renderOptionData(put_options.market_data.oi)}</td>
      </tr>
